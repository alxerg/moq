...
import (
	"github.com/alxerg/moq/pkg/moq/testpackages/dotimport"
	"sync"
)
...
//             UserFn: func(ID string) (dotimport.User, error) {
...
func (mock *ServiceMock) User(ID string) (dotimport.User, error) {
	if mock.UserFn == nil {
		panic("moq: ServiceMock.UserFn is nil but Service.User was just called")
	}
	callInfo := struct {
		ID string
	}{
